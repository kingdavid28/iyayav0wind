  ...
  return (
    ...
    >
      ...
      >
        ...
        <Stack.Screen name="Caregivers" component={CaregiversList} options={{ title: "Caregivers" }} />
        <Stack.Screen name="Children" component={Children} options={{ title: "Your Children" }} />
        <Stack.Screen name="Bookings" component={Bookings} options={{ title: "Bookings" }} />
        <Stack.Screen name="Profile" component={ProfileScreen} options={{ title: "Edit Profile", headerBackTitle: "Back" }} />
        <Stack.Screen name="Chat" component={ChatScreen} options={{ title: "Chat", headerBackTitle: "Back" }} />
        ...
        <Stack.Screen name="Messages" component={Messages} options={{ title: "Messages", headerBackTitle: "Back", headerShown: false }} />
