        ...
        return (
          <View style={styles.stepContainer}>
            ...
            <View>
              ...
              <View style={[styles.inputGroup, errors.startDate && styles.inputError]}>
                <Calendar size={20} color="#6B7280" style={styles.inputIcon} />
                <TextInput
                  style={[styles.input, styles.inputWithIcon]}
                  placeholder="Select start date"
                  value={formatDate(jobData.startDate) || jobData.startDate}
                  onFocus={() => {
                    if (DateTimePicker) {
                      Keyboard.dismiss();
                  ...
                  onChangeText={(text) => setJobData({ ...jobData, startDate: text })}
                />
              </View>
            ...
            <View>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  ...
                  value={formatDate(jobData.endDate) || jobData.endDate}
                  onFocus={() => {
                    if (DateTimePicker) {
                      Keyboard.dismiss();
                  ...
                  onChangeText={(text) => setJobData({ ...jobData, endDate: text })}
                />
              </View>
            </View>
